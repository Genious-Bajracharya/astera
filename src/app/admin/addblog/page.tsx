...
export default function BlogEditor() {
  ...
  return (
    <div className="editor-container space-y-8 bg-gray-50">
      <h2 className='heading3'>Create Blog</h2>
      ...
      <button 
        className='back px-7 py-2.5 rounded-lg cursor-pointer disabled:opacity-50' 
